...
<body>
	...
	<form:form   modelAttribute="customer" method="post">
        <table>	
            ...
            <tr>
                <td>
                    <br/><button type="submit" formaction="/reservation/edit/editReservationNewCustomer?action=add">Aggiungi cliente</button>
                </td>
   
              	<td>
    				<br/><button type="submit" formaction="/reservation/edit/editReservationNewCustomer?action=cancel">Annulla</button>
				</td>
			</tr>
        </table>
     </form:form>
