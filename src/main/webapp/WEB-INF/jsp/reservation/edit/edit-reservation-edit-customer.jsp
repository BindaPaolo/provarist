...
<body>
    ...
    <form:form  modelAttribute="customer" method="post">
        <table>
            ...
            <tr>
                <td>
                    <br/><button type="submit" formaction="/reservation/edit/editReservationEditCustomer?action=cancel">Annulla</button>
                </td>
                <td>
                    <br/><button type="submit" formaction="/reservation/edit/editReservationEditCustomer?action=save">Salva modifiche</button>
                </td>
            </tr>
        </table>
    </form:form>
